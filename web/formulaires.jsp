...
<html>
    ...
    <body>
        <div class="container">
          <div class="jumbotron">
            <h1 class="text-center">MENU PRINCIPALE</h1>
            <div class="row">
                <div class="col"><a class="btn btn-info" href="${pageContext.request.contextPath}/servletDisplayAll?entity=client"> VOIR TOUTES LES INFOS CLIENT <span class="fa fa-eye"></span></a></div>
                <div class="col"><a class="btn btn-info" href="${pageContext.request.contextPath}/servletDisplayAll?entity=bankbranch">VOIR TOUTES LES INFOS BANK <span class="fa fa-eye"></a></div>
                <div class="col"><a class="btn btn-info" href="${pageContext.request.contextPath}/servletDisplayAll?entity=account">VOIR TOUTES LES INFOS ACCOUNT <span class="fa fa-eye"></a></div>
            </div>
          </div>
            <div class="alert alert-secondary" role="alert">
                <p class="text-center">Ordre pour les formulaires : bankBranch -> Account -> Client</p>
            </div>    
        </div>
        <div class="row">
            <!-- CLIENT FORM -->
